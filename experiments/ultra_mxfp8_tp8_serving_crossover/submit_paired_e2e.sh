...
readonly SBATCH_EXTRA_EXPORT_NAMES="SOURCE_ROOT FLASHINFER_ROOT FLASHINFER_COMMIT EXPECTED_CONTAINER_SHA256 EXPECTED_VLLM_VERSION MXFP8_TACTIC_LOOKUP MXFP8_TACTIC_BACKEND MXFP8_TACTIC_SCALE_LAYOUT MXFP8_TACTIC_GPU PAIR_ORDER PAIR_BENCHMARK_SCRIPT MXFP8_TACTIC_LOOKUP_PATH PYTHONDONTWRITEBYTECODE VLLM_MEMORY_PROFILER_ESTIMATE_CUDAGRAPHS"
...
print_plan() {
  ...
  echo "cuda_graph_memory_profiling=true"
